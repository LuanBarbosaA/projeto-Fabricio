...
WEEKDAYS = (('0', ("Segunda-Feira")), ('1', ("Terça-feira")), ('2', ("Quarta-Feira")),
            ('3', ("Quinta-Feira")), ('4', ("Sexta-Feira")), ('5', ("Sábado")),
            ('6', ("Domingo")))

ENGINEERINGS = (('0', '----'), ('1', ('Software')), ('2', ('Eletrônica')),
...
class Booking(models.Model):
    ...
    place = models.ForeignKey(Place, related_name="booking_place", on_delete=models.CASCADE)
